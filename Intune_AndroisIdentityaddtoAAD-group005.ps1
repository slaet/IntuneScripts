...
This script creats an AAD Group if it's not existing, then go trough the Devices in the importetd Device Identifyers, loop troug the Enrolled Devices
if a Device is new enrolled, select that device and add it to the AAD-Group. Also name the Management Name, becaus renaming is not Possible.

.EXAMPLE


.NOTES
Author: Athiraiyan Kugaseelan, Daniel Schaeddler/baseVISION
...
#$passWd= "*********"
$passwd = "xxxxxxxxxxxxxxxxxxxx" | ConvertTo-SecureString 
